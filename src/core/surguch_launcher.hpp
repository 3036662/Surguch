...
/// @brief helper class to open multiply windows when more than 1 file selected to open
...
private:
    ...
    const QString surguch_executable_ = "/home/dv/surguch/surguch/cmake-build-debug/src/surguch";
