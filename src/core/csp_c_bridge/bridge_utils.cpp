...
QString getCertListJSON() noexcept{
    ...
    pdfcsp::c_bridge::CPodResult *const pod=pdfcsp::c_bridge::CGetCertList(params);
    QString res;
    if (pod!=nullptr && pod->user_certifitate_list_json!=nullptr && pod->common_execution_status){
